...
Depth_Control_Channel = 15 #BCM 15 pin
...
RC4_ACTIVATION = 1900  # RC channel 4 activation threshold
...
TIME_HIGH = 0.02
RIGHT_DUTY = 50  # Duty cycle at far right    SUBJECT TO CHANGE
LEFT_DUTY = 10   # Duty cycle at far left
Depth_DUTY_START = 10
Depth_DUTY_PRESS = 60
...
GPIO.setup(Depth_Control_Channel, GPIO.OUT)
...
Servo_Depth = GPIO.PWM(Depth_Control_Channel, PWM_FREQ)
...
while True:  # execute loop forever
    ...
    print("Sleep time:", t)
    # While its going down, even without signal, still have the fish flapping
